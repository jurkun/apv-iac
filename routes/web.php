...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/pendaftaran/{registration}/approve', [RegistrationAdminController::class, 'approve'])->name('registrations.approve');
    Route::post('/pendaftaran/{registration}/reject', [RegistrationAdminController::class, 'reject'])->name('registrations.reject');
